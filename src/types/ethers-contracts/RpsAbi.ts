...
export interface RpsAbiInterface extends utils.Interface {
  functions: {
...
export interface RpsAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RpsAbiInterface;
  ...
  estimateGas: {
    ...
    j2Timeout(overrides?: Overrides & { from?: string }): Promise<BigNumber>;
    ...
    j1Timeout(overrides?: Overrides & { from?: string }): Promise<BigNumber>;
